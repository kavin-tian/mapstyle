 ...
 */
public class GaodeDemoActivity extends CheckPermissionsActivity implements AMap.OnMapLoadedListener, AMap.OnMapClickListener, LocationSource, AMapLocationListener {
    private AMap aMap;
